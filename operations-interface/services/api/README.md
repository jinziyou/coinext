# operations-interface/services/api — Coinext control-plane API
...
pip install -r operations-interface/services/api/requirements.txt
uvicorn app:app --app-dir operations-interface/services/api --host 0.0.0.0 --port 8000 --reload
```
