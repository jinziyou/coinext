"""operations-interface/api/service/api — Coinext control-plane HTTP/WebSocket API (FastAPI).
...
Canonical deployment (see the service/port table): built from ``operations-interface/deployment/docker/api.Dockerfile``,
