"""execution-live/trader-service/service/trader — thin live-trading process wrapper (one process per account).
...
Canonical deployment (service/port table): built from ``operations-interface/deployment/docker/trader.Dockerfile``, runs the
