...
pytest.importorskip("coinext_py", reason="build coinext_py: uvx maturin develop --manifest-path foundation/ffi-bridge/rust/coinext-py/Cargo.toml --features python")
