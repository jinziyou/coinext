...
```bash
just py-setup
just py-build        # builds foundation/crates/coinext-py

uv run python strategy-research/notebooks/quickstart.py
...
jupytext --to notebook strategy-research/notebooks/quickstart.py
jupytext --set-formats ipynb,py:percent strategy-research/notebooks/quickstart.py
jupytext --to py:percent strategy-research/notebooks/quickstart.ipynb
```
