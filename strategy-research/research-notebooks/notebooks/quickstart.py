...
# or just run it: `uv run python strategy-research/research-notebooks/notebooks/quickstart.py` (after building `coinext_py` — see
# `strategy-research/research-notebooks/notebooks/README.md`). It demonstrates the backtest↔live parity invariant from
