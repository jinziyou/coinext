//! MessageBus trait + typed payloads. The in-process bus (impl in `qv-bus`) passes typed
...
use qv_core::TimerEvent;
use qv_model::{Bar, BarType, Fill, InstrumentId, OrderEvent, QuoteTick, StrategyId, TradeTick};
use std::sync::Arc;
