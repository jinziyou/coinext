...
//! which is exactly why `Strategy` is synchronous and `PyStrategyAdapter` (coinext-py) bridges it.
...
/// GIL; Python strategies are bridged by coinext-py's PyStrategyAdapter under the GIL.)
pub trait Strategy {
