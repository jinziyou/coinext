//! `coinext-derivatives` — European option pricing (Black–Scholes) + greeks + implied vol.
//!
...
//! the SAME library a Python strategy uses through `coinext_py` to price options, compute greeks, and
