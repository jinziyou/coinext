//! Account state: per-currency balances and margin. A domain type (lives here, not in coinext-ports)
...
use coinext_core::{Currency, Money};
...
impl AccountState {
    ...
    pub fn adjust(&mut self, delta: Money) -> Result<(), coinext_core::ModelError> {
